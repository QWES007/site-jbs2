...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f6f8] text-[#1e293b] font-sans antialiased">
      ...
      {/* 1. HEADER (Nom sur 2 lignes, 2ème ligne centrée) */}
            ...
            <div className="min-w-0 flex flex-col justify-center">
              <div className="flex items-center gap-2">
                <div className="flex flex-col">
                  <span className="font-extrabold text-xs sm:text-sm text-[#0a2540] tracking-tight leading-snug">
                    {SCHOOL_INFO.fullNamePart1}
                  </span>
                  <span className="font-extrabold text-xs sm:text-sm text-[#0a2540] tracking-tight leading-snug text-center">
      ...
      {/* 4. PORTAILS NUMÉRIQUES (4 Cartes avec DRENA 3) */}
      <section id="portails" className="max-w-7xl mx-auto px-4 lg:px-10 py-12 space-y-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4 hover:shadow-md transition-shadow">
            ...
            <h3 className="font-bold text-base text-[#0a2540]">Portail DRENA 3</h3>
            <p className="text-xs text-slate-500 leading-relaxed">Site officiel de la Direction Régionale de l'Éducation Nationale et de l'Alphabétisation Abidjan 3.</p>
