...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f6f8] text-[#1e293b] font-sans antialiased">
      ...
      {/* IMPRESSION : FICHE OFFICIELLE A4 DE QUALITÉ IMPRIMERIE (PLEINE PAGE) */}
      <div className="hidden print:block p-10 bg-white text-slate-900 font-sans max-w-4xl mx-auto space-y-6 min-h-[297mm]">
        ...
        <div className="flex items-start justify-between border-b-2 border-slate-900 pb-4">
          <div className="flex items-center gap-5">
            <img src={MEDIA_CONFIG.logo} alt="Logo JBS2" className="h-20 w-auto object-contain" />
            <div className="space-y-0.5">
              ...
              <h2 className="text-base font-black text-[#0a2540] uppercase tracking-tight pt-1">{SCHOOL_INFO.fullNamePart1}</h2>
              <h3 className="text-sm font-black text-[#047857] uppercase">{SCHOOL_INFO.fullNamePart2}</h3>
              <p className="text-xs text-slate-600 font-medium pt-0.5">{SCHOOL_INFO.address} • Tél: {SCHOOL_INFO.phone}</p>
            </div>
          </div>
        ...
        <div className="text-center space-y-1.5 py-3 bg-slate-100 rounded-xl border-2 border-slate-800">
          <h2 className="text-lg font-black text-[#0a2540] uppercase tracking-widest">BORDEREAU OFFICIEL DE PRÉINSCRIPTION</h2>
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm bg-slate-50 p-5 rounded-xl border border-slate-300">
            <p className="text-slate-700">Nom & Prénoms : <strong className="text-[#0a2540] uppercase font-black text-base">{formData.nom} {formData.prenom}</strong></p>
            ...
            <p className="text-slate-700">Classe Demandée : <strong className="text-[#047857] font-extrabold text-base">{formData.classe}</strong></p>
            <p className="text-slate-700">Statut Réseau : <strong className="text-slate-900 font-bold">{formData.statut === 'affecte' ? "Affecté(e) de l'État (DRENA 3)" : "Non-Affecté / Inscription Libre"}</strong></p>
            ...
            <p className="text-slate-700">Moyenne Annuelle (MGA) : <strong className="text-[#047857] font-extrabold">{formData.mga ? `${formData.mga} / 20` : 'Non renseignée'}</strong></p>
          </div>
        </div>
        ...
        {/* 3. Pièces Requis (Inspiré du registre officiel) */}
